      ...
      <section className="bg-gradient-to-r from-orange-50 to-red-50">
        <div className="container mx-auto px-4 py-8 relative">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute -right-1/4 -top-1/4 w-1/2 h-1/2 bg-orange-200 rounded-full opacity-10 animate-pulse" />
            <div className="absolute -left-1/4 -bottom-1/4 w-1/2 h-1/2 bg-red-200 rounded-full opacity-10 animate-pulse" />
          </div>
          ...
          <div className="relative text-center max-w-3xl mx-auto space-y-6">
            <div className="space-y-4 animate-fade-in">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 tracking-tight">
                ...
                <span className="text-orange-500"> at Direct Prices</span>
              </h1>
